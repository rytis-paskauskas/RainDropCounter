#! /usr/bin/env python
# Time-stamp: <2024-02-27 11:07:46 rytis>
#
import sys
import json
...
# git clone rainml
from rainml.tfmodels import model_densnet
...
def main():
    ...
    for idx in range(runs):
        ...
        with strategy.scope():
            ...
            m = model_densnet(model_DSP, dsp_reg, model_K, model_M, model_FC)
