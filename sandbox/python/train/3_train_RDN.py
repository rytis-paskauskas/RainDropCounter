#! /usr/bin/env python
# Time-stamp: <2024-04-04 09:19:44 rytis>
#
import sys
import json
...
# git clone rainml
from rainml.tfmodels import model_RDN
...
def main():
    ...
    .batch(batch_size, drop_remainder=False, num_parallel_calls=8, deterministic=True)\
    .shuffle(100, seed=46, reshuffle_each_iteration=False).prefetch(1)
    ...
    for idx in range(runs):
        ...
        with strategy.scope():
            ...
            m = model_RDN(model_DSP, dsp_reg, model_K, model_M, model_FC)
